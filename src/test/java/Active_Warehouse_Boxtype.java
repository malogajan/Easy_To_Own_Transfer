...
public class Active_Warehouse_Boxtype {
    @Test(priority = 0)
        //Run|Debug
    void GetAllActiveWarehouseBoxType () {
        ...
        (contentType != null && contentType.contains("json")) {
            ...
            Assert.assertTrue(responseBody.contains("boxType"));
            System.out.println("boxType:" + responseBody);
        } else {
