...
public class Transfer_Dispatch_Detail {
    ...
    void GetTransferDispatchDetail () {
        ...
        Response response = given().
                ...
                //body(requestBody).
                        when().
                get("http://10.111.111.139:7019/api/EasyToOwnTransfer/GetTransferDispatchDetail?receiptId=7");
    ...
    void GetTransferDispatchDetail_With_InvalidReceiptId () {
        ...
        Response response = given().
                ...
                //body(requestBody).
                        when().
                get("http://10.111.111.139:7019/api/EasyToOwnTransfer/GetTransferDispatchDetail?receiptId=70");
