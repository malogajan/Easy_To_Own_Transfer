...
public class Receive_Stock_Summary_By_Batch {
    @Test(priority = 0)
    void GetReceiveStockSummaryByBatch() {
    ...
    @Test(priority = 1)
    void GetReceiveStockSummaryByBatch_With_Invalid_SystemBatchNumber() {
    ...
    @Test(priority = 2)
    void GetReceiveStockSummaryByBatch_With_Blank_SystemBatchNumber() {
        // Send the request
        String requestBody = "";  // Set the request body if needed
        Response response = given().
                header("Content-Type", "application/json").
