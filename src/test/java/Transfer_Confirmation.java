...
public class Transfer_Confirmation {
    ...
    void GetTransferConfirmation () {
        ...
        Response response = given().
                ...
                //body(requestBody).
                        when().
                get("http://10.0.0.26:7019/api/EasyToOwnTransfer/GetTransferConfirmation?receiptNo=7&qtySum=1&codeTo=Q215756&isWarehouseTransfer=true");
    ...
    void GetTransferConfirmationStatuswith_Invalid_ReceiptNo () {
        ...
        Response response = given().
                ...
                //body(requestBody).
                        when().
                get("http://10.0.0.26:7019/api/EasyToOwnTransfer/GetTransferConfirmation?receiptNo=5655656565657&qtySum=1&codeTo=Q215756");
    ...
    void GetTransferConfirmationStatuswith_Invalid_QTYSUM() {
        ...
        Response response = given().
                ...
                //body(requestBody).
                        when().
                get("http://10.0.0.26:7019/api/EasyToOwnTransfer/GetTransferConfirmation?receiptNo=7&qtySum=-1&codeTo=Q215756");
    ...
    void GetTransferConfirmationStatuswith_Blank_QTYSUM() {
        ...
        Response response = given().
                ...
                //body(requestBody).
                        when().
                get("http://10.0.0.26:7019/api/EasyToOwnTransfer/GetTransferConfirmation?receiptNo=7&codeTo=Q215756");
    ...
    void GetTransferConfirmationStatuswith_Less_QTYSUM() {
        ...
        Response response = given().
                ...
                //body(requestBody).
                        when().
                get("http://10.0.0.26:7019/api/EasyToOwnTransfer/GetTransferConfirmation?receiptNo=7&qtySum=-0&codeTo=Q215756&isWarehouseTransfer=true");
    ...
    void GetTransferConfirmationStatuswith_More_QTYSUM() {
        ...
        Response response = given().
                ...
                //body(requestBody).
                        when().
                get("http://10.0.0.26:7019/api/EasyToOwnTransfer/GetTransferConfirmation?receiptNo=7&qtySum=100&codeTo=Q215756&isWarehouseTransfer=true");
    ...
    void GetTransferConfirmationStatuswith_Invalid_CodeTo() {
        ...
        Response response = given().
                ...
                //body(requestBody).
                        when().
                get("http://10.0.0.26:7019/api/EasyToOwnTransfer/GetTransferConfirmation?receiptNo=7&qtySum=1&isWarehouseTransfer=true");
    ...
    void GetTransferConfirmationStatuswith_Blank_CodeTo() {
        ...
        Response response = given().
                ...
                //body(requestBody).
                        when().
                get("http://10.0.0.26:7019/api/EasyToOwnTransfer/GetTransferConfirmation?receiptNo=7&qtySum=1");
